            ...
            <div className="newMemberPageContainer">
                <form action="/api/newuser" method="post" className='newMemberRegistrationForm'>
                    <div className="vertical">
                        ...
                        <input className="textField" type="text" id="firstname" name="firstname" required minLength={2} maxLength={20}/>
                    </div>
                    <div className="vertical">
                    ...
                    <div style={{display: 'flex'}}>
                        <div className="vertical" style={{width: '500px'}}>
                            <label htmlFor="address">Street Address:</label>
                            <input className="textField" type="text" id="address" name="address" required minLength={5}/>
                        </div>
